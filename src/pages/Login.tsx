    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-background p-4">
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">Your data is automatically saved across all devices</p>
        </div>

        <div className="mt-8 p-6 bg-white shadow-sm rounded-lg border border-border glass">
          <div className="text-center">
            <p>You are automatically signed in for a seamless experience.</p>
            <div className="mt-4">
              <Button
          ...
          <div className="mt-6 border-t border-border pt-4">
            <p className="text-sm text-center text-muted-foreground">
              Your data is synced across all devices automatically
            </p>
          </div>
        </div>
      </div>
